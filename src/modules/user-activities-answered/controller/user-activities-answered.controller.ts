import { Body, Controller, HttpException, Param, Post, Req, Res, UnauthorizedException } from '@nestjs/common';
import { ApiBearerAuth, ApiResponse, ApiTags } from '@nestjs/swagger';
import { UserActivitiesAnsweredService } from '../services/user-activities-answered.service';
import { Request, Response } from 'express';
import { AnswerQuestionRequestDTO, AnswerQuestionResponseDTO } from '../domain/requests/AnswerQuestion.request.dto';
...
export class UserActivitiesAnsweredController {
    ...
    async answerActivity(
        ...
        const result = await this.userActivitiesAnsweredService.answerQuestion(user.id, activityId, body.answer)
